...
public class ListFTP extends ListBase {
	...
	public void connect() {
		...
		AlertDialog alr = new AlertDialog.Builder(fmMain.CONTEXT).setTitle(R.string.conng)
				.setIcon(R.drawable.ic_menu_globe).setView(formcon).setNegativeButton(R.string.cansel, cansl)
				.setPositiveButton(R.string.ok, editdom).setOnCancelListener(back).create();
