...
public class HorizontalPager extends ViewGroup {
	...
	// "ru.megazlo.sdmanager.pager.HorizontalPager";
	 ...
	 * current page (and no other scrolling is occurring). Use this to pass a
	 * value to scrollTo(), for example.
	 * 
	 * @param whichPage
	 * @return
	 */
	...
	public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
		return (indexOfChild(child) != mCurrentPage || !mScroller.isFinished());
	}

	@Override
	protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
		int focusableScreen = mNextPage != INVALID_SCREEN ? mNextPage : mCurrentPage;
	...
	public static interface OnScrollListener {
		 ...
		 * assume the left edge of the first page has a scroll position of 0. Note
		 * that values less than 0 and greater than the right edge of the last page
		 * are possible due to touch events scrolling beyond the edges.
		 * 
		 * @param scrollX
		 *          Scroll X value
		 */
