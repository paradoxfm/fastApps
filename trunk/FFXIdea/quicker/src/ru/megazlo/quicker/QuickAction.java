...
public class QuickAction extends CustomPopupWindow {
	 ...
	 * 
	 * @param anchor
	 *          {@link android.view.View} on where the popup should be displayed
	 */
	 ...
	 * 
	 * @param action
	 *          {@link ru.megazlo.quicker.ActionItem}
	 */
	 ...
	 *          action item title
	 * @param icon
	 *          {@link android.graphics.drawable.Drawable} action item icon
	 * @param listener
	 *          {@link android.view.View.OnClickListener} action item listener
