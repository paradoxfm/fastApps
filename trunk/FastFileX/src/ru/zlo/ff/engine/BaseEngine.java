...
import ru.zlo.ff.util.ConnectionRecort;
...
import ru.zlo.ff.util.net.ConnectNet;
...
public abstract class BaseEngine implements IEngine {
	...
	public Integer getIcoProtocol() {
		...
		case FTP:
			return R.drawable.prot_ftp;
		case LAN:
			return R.drawable.prot_smb;
		default:
			return R.drawable.prot_pda;
		}
	}
	...
	protected Object execConnect(Context c, boolean isFTP) {
		...
		AlertDialog alr = new AlertDialog.Builder(c).setTitle(R.string.conng).setIcon(R.drawable.prot_ftp).setView(formcon)
				.setNegativeButton(R.string.cansel, cansl).setPositiveButton(R.string.ok, editdom).setOnCancelListener(back)
				.create();
